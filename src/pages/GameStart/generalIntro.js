  ...
  render() {
    ...
    return (
      <div>
        ...
        <Container style={{ whiteSpace: "pre-line" }}>{gameRule}</Container>
        <Header as="h2" color="teal">
          <Header.Content>Market Introduction</Header.Content>
          <Header.Subheader>Market Situation</Header.Subheader>
        </Header>
        <Container style={{ whiteSpace: "pre-line" }}>{desOfFirms}</Container>
        <Header as="h2" color="teal">
          <Header.Subheader>Model of Market Structure</Header.Subheader>
        </Header>
        <Container style={{ whiteSpace: "pre-line" }}>{marketDes}</Container>
        <Header as="h2" color="teal">
          <Header.Subheader>Firm's Objective</Header.Subheader>
        </Header>
        <Container style={{ whiteSpace: "pre-line" }}>{goalOfFirms}</Container>
      </div>
    );
  }
}
